    ...
    <>
      ...
      <section class="text-gray-600 body-font">
        <div class="container px-5 py-24 mx-auto flex flex-wrap">
          ...
          <div class="md:w-3/5 md:pl-6">
            <p class="leading-relaxed text-base">
            Service Element It is equal to service pension to which he/she would have been entitled on the basis of his/her pay on the date of invalidment i.e. 50% of last drawn.
